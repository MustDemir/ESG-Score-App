...
function TabletFrame({ children, width = 1024, height = 720 }) {
  // Simple landscape tablet bezel — kein iOS-Frame nötig, da E3 als Mock dient
  return (
    <div style={{
      width, height, borderRadius: 28,
      background: '#1a1814',
      padding: 14, boxSizing: 'border-box',
      boxShadow: '0 18px 48px rgba(0,0,0,0.18), 0 4px 12px rgba(0,0,0,0.06)',
    }}>
      <div style={{
  ...
  return (
    <>
      ...
      >
        ...
        <DCSection id="onboarding" title="Onboarding — Erstkontakt">
          <DCArtboard id="o1" data-screen-label="O1 Welcome" label="O1 — Willkommen" width={420} height={880}>
            <div style={{ background: SF_C.bgAlt, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <PhoneFrame><O1_Welcome/></PhoneFrame>
            </div>
          </DCArtboard>
          <DCArtboard id="o2" data-screen-label="O2 Wie es funktioniert" label="O2 — Wie es funktioniert" width={420} height={880}>
            <div style={{ background: SF_C.bgAlt, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <PhoneFrame><O2_How/></PhoneFrame>
            </div>
          </DCArtboard>
          <DCArtboard id="o3" data-screen-label="O3 Datenquellen" label="O3 — Datenquellen &amp; Vertrauen" width={420} height={880}>
            <div style={{ background: SF_C.bgAlt, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <PhoneFrame><O3_Trust/></PhoneFrame>
            </div>
          </DCArtboard>
        </DCSection>

        <DCSection id="edge" title="Edge-States — wenn etwas fehlt">
          <DCArtboard id="s5" data-screen-label="S5 Not Found" label="E0 — Produkt nicht gefunden" width={420} height={880}>
            <div style={{ background: SF_C.bgAlt, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <PhoneFrame><S5_NotFound/></PhoneFrame>
            </div>
          </DCArtboard>
          <DCArtboard id="e1" data-screen-label="E1 Offline" label="E1 — Offline (gecachte Scans)" width={420} height={880}>
            <div style={{ background: SF_C.bgAlt, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <PhoneFrame><E1_Offline/></PhoneFrame>
            </div>
          </DCArtboard>
          <DCArtboard id="e2" data-screen-label="E2 Low-Data" label="E2 — Datengrundlage zu dünn" width={420} height={880}>
            <div style={{ background: SF_C.bgAlt, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <PhoneFrame><E2_LowData product={COSMETICS}/></PhoneFrame>
            </div>
          </DCArtboard>
        </DCSection>

        <DCSection id="tablet" title="Tablet — gleiche Logik, breiteres Grid">
          <DCArtboard id="e3" data-screen-label="E3 Tablet" label="E3 — Tablet · 2-Spalten Result-Screen" width={1080} height={780}>
            <div style={{ background: SF_C.bgAlt, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <TabletFrame width={1024} height={720}>
                <E3_TabletResult product={FOOD}/>
              </TabletFrame>
            </div>
          </DCArtboard>
        </DCSection>
