...
checks = {
  ...
  "docs/project/quality-strategy.md" => [
    "G-CMP-SCHEMA",
    "G-COMPLIANCE-HORIZON",
    "G-REGULATORY-APPLICABILITY",
    "G-UWG-COMPARISON-TRANSPARENCY",
    "G-DATA-LICENSE",
    "G-METHOD-CATALOG",
    "G-LINK-INTEGRITY",
    "G-MISSING-DATA",
  ...
  "docs/project/tickets/README.md" => [
    "Definition of Ready",
    "Definition of Done",
    "G-PROJECT-CONTROL",
    "ticket-index.yaml",
  ...
  "docs/project/tickets/ticket-schema.yaml" => [
    "scanfair-ticket-schema-v1",
    "required_fields",
    "required_gates_by_ticket_type",
  ],
  ...
  "docs/project/compliance/regulatory-horizon.yaml" => [
    "HZN-APPLE-APP-REVIEW",
    "HZN-EU-GREEN-TRANSITION",
    "automatic_approval: prohibited",
    "baseline_compared_non_blocking_manual_change_assessment",
    "capability-declaration-contract.yaml",
    "fresh_observation_requires_signature_bound_manual_review",
  ],
  "docs/project/compliance/capability-declaration-contract.yaml" => [
    "feature_third_party_ai_enabled",
    "manual_attestation",
    "static_presence",
  ],
  ...
  "docs/project/audits/2026-09-04-control-assurance-review.md" => [
    "CA-001",
    "CA-002",
    "CA-003",
  ],
  ...
  "docs/project/compliance/font-assets.yaml" => [
    "runtime_fetching_allowed: false",
    "esg_app/assets/fonts/Inter-Regular.ttf",
    "esg_app/assets/fonts/InstrumentSerif-Regular.ttf",
    "sha256",
  ],
